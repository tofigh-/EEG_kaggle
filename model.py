...
class DCGAN(object):
    ...
    def train(self, config):
        ...
        elif config.dataset == 'eeg':
            data_X, data_y = self.load_kaggle()
        else:
        ...
        if config.dataset == 'mnist' or config.dataset == 'eeg':
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if np.mod(counter, 100) == 1:
                    ...
                    save_images(samples, [8, 8],
                                './samples_eeg/train_{:02d}_{:04d}.png'.format(epoch, idx))
